...
export default function Sider() {
  ...
  const mainMenu = [
    ...
    },
    {
      ...
      href: "/admin/report/resource-allocation",
    },
    {
      icon: <FaUser />,
      label: "Student Participation",
      href: "/admin/report/student-participation",
    },
    {
      icon: <FaUserGroup />,
      label: "Evaluation Data",
      href: "/admin/report/evaluation-data",
    },
  ];
  ...
  return (
    <nav className="bg-white border-r border-gray-200 w-[240px] h-[calc(100vh-70px)] fixed top-[70px] left-0 overflow-y-auto">
      {/* Scrollbar nhỏ */}
      <style jsx>{`
          ...
          return (
            <li key={item.href}>
              <Link
                ...
                ${
                  isActive
                    ? "bg-[#0C54E4] text-white before:content-[''] before:block before:w-[4.5px] before:h-full before:rounded-r-md before:bg-[#0C54E4] before:absolute before:top-0 before:-left-6"
