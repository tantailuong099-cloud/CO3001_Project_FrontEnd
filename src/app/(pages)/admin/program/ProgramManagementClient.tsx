...
import AssignTutorModal from '@/app/components/modal/AssignTutorModal';
...
export default function ProgramManagementClient() {
  ...
  const [activeTab, setActiveTab] = useState<'program-list' | 'assign-tutor'>('program-list');
  ...
  const handleRemoveTutor = (tutorName: string) => {
    if (selectedCourse) {
      ...
      console.log(`Removed tutor ${tutorName} from course ${selectedCourse.id}`);
    }
  };
