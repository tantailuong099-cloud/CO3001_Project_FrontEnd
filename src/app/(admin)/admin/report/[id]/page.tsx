  ...
  if (id === "resource-allocation") {
    return (
      <div className="p-6 space-y-8 bg-gray-50 min-h-screen">
        ...
        <div className="bg-[#CDDCF9] border rounded-md shadow-sm mt-8 overflow-x-auto text-black">
    ...
    return (
      <div className="min-h-screen bg-white p-6">
        ...
        <div className="mt-6 mx-6 flex items-center justify-between">
          ...
          <div>
            <button className="bg-[#0C54E4] hover:bg-[#041C4C] text-white px-4 py-1 rounded transition text-sm">
              Generate Report
            </button>
          </div>
        </div>
        ...
        <div className="mx-6 mt-4 border rounded-md shadow-sm bg-[#CDDCF9]">
          {/* header row above table (thin colored header like image) */}
          <div className="bg-[#5D8DED] px-3 py-2 flex items-center rounded-t-md border-b">
  ...
  if (id === "evaluation-data") {
    return (
      <div className="min-h-screen bg-white p-6">
        ...
        {/* Table container */}
        <div className="mx-6 mt-4 border rounded-md shadow-sm bg-[#CDDCF9] text-black">
